...
export function Button({ label, variant = "primary", href, className, ...props }: ButtonProps & ButtonHTMLAttributes<HTMLButtonElement>) {
  const styles = cn(
    "type-button group inline-flex h-11 min-h-11 items-center justify-center gap-2.5 rounded-md border px-5 transition-all duration-200 active:scale-[0.98] active:duration-100 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-accent",
